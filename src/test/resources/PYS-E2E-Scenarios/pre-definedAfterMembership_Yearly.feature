Feature: Pick Your Slot activity booking for pre-defined slot after membership type Yearly end to end

  Background:
    Given user login with username "9790144501" and password "123456"
