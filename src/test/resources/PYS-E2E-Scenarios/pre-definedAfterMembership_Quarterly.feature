Feature: Pick Your Slot activity booking for pre-defined slot after membership type Quarterly end to end
  ...
  Scenario Outline: User buy a membership type "Quarterly"
    ...
    And user select "Quarterly" Membership plan user click "Join Now" button
