Feature: Pick Your Slot activity booking for net practice slot after membership type MONTHLY end to end

  Background:
    Given user login with username "8098135709" and password "123456"
